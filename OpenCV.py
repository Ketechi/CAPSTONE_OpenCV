...
while True:
    ...
    for contour in contours:
        ...
        # momentumX = int(momentum['m10'] / momentum['m00'])
        # momentumY = int(momentum['m01'] / momentum['m00'])

        # Draw the center and the contour
        drawArea = cv2.contourArea(contour)
        if drawArea > 20 and drawArea < 500:
            cv2.drawContours(frames, contour, -1, (0, 255, 0), 1)
            # cv2.circle(frames, (momentumX, momentumY), 10, (0, 255, 0), -1)
